export default {
  ...
  "exercise.dragDrop": "Glissez et déposez la bonne réponse",
  "exercise.matching": "Associez correctement les éléments",
  "exercise.submit": "Soumettre",
  ...
  "footer.copyright": "© 2025 TrioSigno. Tous droits réservés.",
